...
Dado("acesse o meu desconto") do
  @screen.home.selecionar_opcao_menus("Meu desconto")
end
Dado("clico em pular") do
  @screen.meu_desconto.pular
end
Então("devo ver as ofertas") do
  elemento = @screen.meu_desconto.ofertas
...
Dado("clico em login") do
  @screen.meu_desconto.btn_login
end

# codigo comentado para revisão
